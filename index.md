...
An overview of our research efforts and future directions in understanding the condensation phenomenon of deep learning. By advancing our current research program, we anticipate developing a novel framework that establishes a rigorous mathematical foundation for deep learning. See [Publications](https://yaoyuzhang1.github.io/publications/) for details.
...
- Optimistic Sample Size Estimate for Deep Neural Networks. One World Seminar Series on the Mathematics of Machine Learning, Oct. 9, 2024. ([slides](https://yaoyuzhang1.github.io/file/Lectures/Optimistic%20estimate.pdf), [video](https://youtu.be/s2jNsXmga6A))
